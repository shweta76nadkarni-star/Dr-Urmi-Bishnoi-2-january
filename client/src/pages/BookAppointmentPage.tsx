...
const benefits = [
  {
    ...
    description:
      "Your privacy is our priority. All sessions are strictly confidential.",
  },
  {
    icon: Heart,
...
export default function BookAppointmentPage() {
  ...
  useEffect(() => {
    document.title =
      "Book Appointment | Dr. Urmil Bishnoi - Best Psychologist in Jaipur";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute(
        "content",
        "Book your confidential therapy appointment with Dr. Urmil Bishnoi, Jaipur's leading psychologist. Online and in-person sessions available. Call +91 8042756155.",
      );
    } else {
...
Please confirm my appointment. Thank you!`;
    ...
    toast({
      ...
      description:
        "Redirecting to WhatsApp to confirm your appointment with Dr. Urmil Bishnoi.",
    });
  }
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              >
                ...
                confidential consultation with Dr. Urmil Bishnoi, one of
                Jaipur's most trusted psychologists.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16 max-w-4xl mx-auto">
              {benefits.map((benefit, index) => (
                ...
                >
                  <Card
                    className="h-full border-none shadow-sm bg-white text-center"
                  ...
                  <CardContent className="p-8">
                    <Form {...form}>
                      ...
                      >
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    <SelectItem value="In-Person (Clinic Visit)">
                                      In-Person (Clinic Visit)
                                    </SelectItem>
                                    <SelectItem value="Online (Video Call)">
                                      Online (Video Call)
                                    </SelectItem>
                                    <SelectItem value="Phone Consultation">
                                      Phone Consultation
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
                        ...
                        >
                          <MessageCircle className="mr-2 h-5 w-5" /> Book via
                          WhatsApp
                        </Button>
                      </form>
                    </Form>
                ...
                <Card className="border-none shadow-lg bg-gradient-to-br from-primary to-primary/80 text-white mb-6">
                  <CardContent className="p-6">
                    ...
                    <p className="text-primary-foreground/90 mb-4 text-sm">
                      For immediate assistance or to book your appointment
                      directly, call or WhatsApp us.
                    </p>
                    <a href="tel:+918042756155">
                      ...
                      >
                        <Phone className="mr-2 h-5 w-5" /> +917014086770
                      </Button>
                    </a>
                  </CardContent>
                </Card>
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Taking the first step toward mental wellness is an act of
                courage. Dr. Urmil Bishnoi is here to support you every step of
                the way.
              </p>
              <p className="text-primary font-semibold text-lg">
                "The greatest step towards a life of simplicity is to learn to
                let go." - Steve Maraboli
              </p>
            </motion.div>
          </div>
        </section>
